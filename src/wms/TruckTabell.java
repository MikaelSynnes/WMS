...
public TruckTabell(){
    ...
    public Scene getScene(Stage stage) {
        ...
        TableColumn<Truck, Truck> deleteCol = new TableColumn<>("Handling");
        deleteCol.setCellValueFactory(
            param -> new ReadOnlyObjectWrapper<>(param.getValue())
        );
        deleteCol.setCellFactory(param -> new TableCell<Truck, Truck>() {
            ...
            protected void updateItem(Truck truck, boolean empty) {
                ...
                deleteButton.setOnAction(
                    event -> getTableView().getItems().remove(truck)
                );
            }
        });
        ...
        table.setItems(data);
        table.getColumns().addAll(truckNrCol, ansvarligCol, operativCol, modelCol, serviceCol,deleteCol);
